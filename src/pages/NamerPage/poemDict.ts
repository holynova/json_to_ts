export const poemDict = {
  ...
  poem_318: {
    content:
      "回乐峰前沙似雪，受降城外月如霜。(回乐 一作：回乐）不知何处吹芦管，一夜征人尽望乡。",
    title: "夜上受降城闻笛",
    author: "李益",
    book: "唐诗三百首",
    dynasty: "唐代",
  ...
  poem_458: {
    content:
      "朝闻游子唱离歌，昨夜微霜初渡河。鸿雁不堪愁里听，云山况是客中过。关城树色催寒近，御苑砧声向晚多。(色 一作：曙)莫见长安行乐处，空令岁月易蹉跎。",
    title: "送魏万之京",
    author: "李颀",
    book: "唐诗三百首",
    dynasty: "唐代",
  ...
  poem_459: {
    content:
      "群山万壑赴荆门，生长明妃尚有村。一去紫台连朔漠，独留青冢向黄昏。画图省识春风面，环佩空归夜月魂。(夜月 一作：月夜 环 一作：环)千载琵琶作胡语，分明怨恨曲中论。",
    title: "咏怀古迹五首·其三",
    author: "杜甫",
    book: "唐诗三百首",
    dynasty: "唐代",
  ...
  poem_493: {
    content:
      "斜阳照墟落，穷巷牛羊归。(斜 一作：光)野老念牧童，倚杖候荆扉。雉雊麦苗秀，蚕眠桑叶稀。田夫荷锄至，相见语依依。即此羡闲逸，怅然吟式微。",
    title: "渭川田家",
    author: "王维",
    book: "唐诗三百首",
    dynasty: "唐代",
